#!/system/bin/sh
if ! applypatch --check EMMC:/dev/block/by-name/recovery$(getprop ro.boot.slot_suffix):71106560:5425c042dba3954ab71aed920c360309e9b1366f; then
  applypatch \
          --patch /system/recovery-from-boot.p \
          --source EMMC:/dev/block/by-name/boot$(getprop ro.boot.slot_suffix):61865984:27ce0a2cecd695cea604944d2adb0e8ad7bdd320 \
          --target EMMC:/dev/block/by-name/recovery$(getprop ro.boot.slot_suffix):71106560:5425c042dba3954ab71aed920c360309e9b1366f && \
